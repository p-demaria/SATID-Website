            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="methodology-overview.html">Overview</a>
                        <a href="support-levels.html">Support Levels</a>
                        <a href="risk-scoring.html">Risk Scoring</a>
                    </div>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropbtn">Analysis</a>
                    <div class="dropdown-content">
                        <a href="portfolio-risk-dashboard.html">Portfolio Risk</a>
                        <a href="individual-etf-risk.html">Individual ETF Risk</a>
                        <a href="portfolio_dashboard.html" class="active">Portfolio Performance</a>
                    </div>
                </li>
