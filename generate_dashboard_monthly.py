...
<head>
    ...
    <title>Portfolio Analysis Dashboard - Monthly Data</title>
    <style>
/* ============================================
   SATID MASTER STYLESHEET - Portfolio Dashboard
   ============================================ */
...
<body>
    <div class="hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Professional Portfolio Analytics & Performance Metrics (Monthly Data)</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-page">
            ...
            <div class="content-section">
                <h2>Model Portfolio Profiles</h2>
...
"""
    ...
    <footer>
        <p><strong>Portfolio Analysis Dashboard - Monthly Data</strong></p>
