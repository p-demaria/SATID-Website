...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-logo">SATID</div>
            <ul class="nav-menu">
                <li><a href="index.html">Home</a></li>
                <li><a href="philosophy.html">Philosophy</a></li>
                <li class="dropdown">
                    <a href="#" class="dropbtn">Methodology</a>
                    <div class="dropdown-content">
                        <a href="methodology.html">Overview</a>
                        <a href="risk-level-setting.html">Risk Level Setting</a>
                        <a href="portfolio-construction.html">Portfolio Construction</a>
                        <a href="support-level-calculation.html">Support Level Calculation</a>
                        <a href="portfolio-risk-management.html">Portfolio Risk Management</a>
                    </div>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropbtn">Analysis</a>
                    <div class="dropdown-content">
                        <a href="dashboard.html">Portfolio Dashboard</a>
                        <a href="support-levels.html">Support Levels</a>
                        <a href="risk-exposure.html">Risk Exposure</a>
                        <a href="performance.html">Performance Analytics</a>
                    </div>
                </li>
                <li><a href="model_portfolios.html" class="active">Model Portfolios</a></li>
