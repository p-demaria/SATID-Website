...
2. Generate Portfolio Risk Exposure → HTML
3. Generate SATID Risk Score → HTML + Excel dashboard
4. Generate Portfolio Risk Dashboard → HTML
5. All outputs use existing FBIS parameters from JSON file
